 ...
 *
 * The grid mounts this only for insights with several charts
 * (`isGroupedInsight`); a single-chart insight renders as a plain standalone
 * card instead — no grouping chrome around one chart.
 *
