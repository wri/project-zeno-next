...
import { mapInsightsResponse } from "@/app/lib/map-insight-response";
import type { InsightWidget } from "@/app/types/chat";

// Fetches the authenticated user's persisted insights from GET /api/insights
// and flattens them to the flat InsightWidget shape the UI renders. A 401
// (unauthenticated) or other failure resolves to an empty list rather than
// throwing — the insights panel shows its empty state instead of erroring.
