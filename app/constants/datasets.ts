...
export const DATASET_CARDS: (DatasetCardConfig & { img?: string })[] = [
  ...
  },
  {
    ...
    tile_url:
      "https://tiles.globalforestwatch.org/umd_tree_cover_density_2000/v1.8/tcd_{tc_threshold}/{z}/{x}/{y}.png",
    configurable_params: {
