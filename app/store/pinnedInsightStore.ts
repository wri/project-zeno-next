...
interface PinnedInsightState {
  insights: PinnedInsight[];
  hasSeeded: boolean;
  hasHydrated: boolean;
}

interface PinnedInsightActions {
  addInsight: (
...
const usePinnedInsightStore = create<
  PinnedInsightState & PinnedInsightActions
>()(
  persist(
    (set, get) => ({
      insights: [],
...
export default usePinnedInsightStore;
