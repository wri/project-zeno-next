...
// Skeleton shown in the dashboard content column while the dashboard loads:
// the same white card / 8px radius / hairline border chrome the real content
// card uses, so the skeleton settles into the real layout without a jump.

/** A single shimmering placeholder block: a light-grey base with one soft,
 *  angled white band swept across it (`shimmerSweep`). */
